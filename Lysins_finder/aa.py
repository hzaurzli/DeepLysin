            ...
            if all(element==0 for element in datasize) != 0:
              ...
              if not os.path.getsize('./all_protein.faa'):
                ...
                if state == 'Y':
                  ...
                  list_CBD = []
                  f_CBD = curr_dir_rpc + reported_lysin_CBD_suffix
                  for i in f_CBD:
                    item = i.strip()
                    f_CBD.append(item)
                  
                  list_EAD = []
                  f_EAD = curr_dir_rpe + reported_lysin_EAD_suffix
                  for i in f_EAD:
                    item = i.strip()
                    f_EAD.append(item)
                  ...
                  for lines in f2:
                    ...
                    id_2 = line[0]
                    if line[1] in f_EAD:
                      pf = line[2] + '&' + 'EAD' + '&' + line[2] + '&' + line[3] + '&'  + line[4]
                      if id_2 in dic_info.keys():
                        dic_info[id_2].append(pf)
                    if line[2] in f_CBD:
                      pf = line[1] + '&' + 'CBD' + '&' + line[2] + '&' + line[3] + '&'  + line[4]
                      if id_2 in dic_info.keys():
                        dic_info[id_2].append(pf)
                ...
                if os.path.isdir('./phispy_out/') == True:
                    ...
                    os.system('rm -r ./hmmer_database/ ./hmmer_out/ ./hmmer_out_EAD/ ./orf_ffn/ ./DBSCAN_SWA_out/ ./prokka_result/ ./biolib_results/') 
